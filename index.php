...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <?php wp_head(); ?>
  <script type="text/javascript" src="http://hackerslab.eu/mathjax/MathJax.js?config=default"></script>
  </head>
  <body <?php body_class(); ?>>
    <div id="container">
      <div id="header">
	...
	<div id="footer">
	<?php if (is_user_logged_in()) { ?> <a href="<?php bloginfo('wpurl'); ?>/wp-admin/">Dashboard</a> &#183; <?php } else { } ?> <?php wp_loginout(); ?><br />
	<?php wp_footer(); ?>
	</div><!-- container -->
  </body>
</html>
